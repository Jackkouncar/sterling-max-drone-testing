"""Shared settings for ModalAI Starling 2 testing in a small netted tent."""
...
# Tent constraint: 7 ft x 7 ft, launching from center.
# 0.8 m keeps margin for the drone body, prop wash drift, and position error.
TRANSIT_DISTANCE_M = 0.8
TRANSIT_DURATION_S = 5.0
